...
It was the worst of times.
    ...
    assert_equal "\n", long_string[0,1] # long_string[54, x] x >= 54 => ""
  end

  def test_here_documents_can_also_handle_multiple_lines
    # Stream has at least one \n
    # <<EOS = beginning and EOS = end of Stream
    # beginning and end has to be in own line
    # \n after beginning not counted
    # \n before end counted
    long_string = <<EOS
It was the best of times,
It was the worst of times.
EOS
  ...
  def test_you_can_get_a_substring_from_a_string
    ...
    assert_equal "let", string[7,3] # string[offset, length], length characters including the the character at index of offset
